package com.chikuo.config;

import com.chikuo.intercepter.BackInterceptor;
import com.chikuo.intercepter.ForeInterceptor;
...
public class MyWebMvcConfigurerAdapter extends WebMvcConfigurerAdapter {
     ...
     * 在这里配置后就不需要那么麻烦了，直接访问http://localhost:80/toLogin就跳转到login.html页面了
     *
     * @param registry
     */
    @Override
